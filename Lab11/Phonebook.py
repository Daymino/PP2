...
def main():
    ...
    cursor.execute("""CREATE TABLE IF NOT EXISTS phonebook2(
    Id BIGSERIAL,
...
"""))
        match inp:
            case 1: #adds user
                ...
                cursor.execute("""INSERT INTO phonebook2(First_name, Last_name,Phone_number) VALUES(%s, %s,%s)
            ...
            case 2: #deletes from table
                ...
                lname=input("Last name: ")
                phone=input("Phone number: ")
                cursor.execute("""DELETE FROM phonebook2 WHERE First_name = %s 
            ...
            case 3: #querying data
                ...
                lname=input("Last name: ")
                phone = input("Phone number: ")
                cursor.execute(f"""SELECT * FROM phonebook2 WHERE First_name LIKE '%{fname}%' 
            ...
            case 4:#pagination
                ...
                cursor.execute("""SELECT Id, First_name, Last_name,Phone_number 
                            FROM phonebook2 ORDER BY """+order+""" OFFSET %s LIMIT %s""", (page, size))
                res = cursor.fetchall()
                for r in res:
                    print(r[0],'--',r[1],'--',r[2],'--',r[3])
            ...
            case 6:#Inserting thourgh the list
                ...
                for person in li:
                    if Validnumber(person[2]):
                        cursor.execute("""INSERT INTO phonebook2 (First_name,Last_name,Phone_number) 
